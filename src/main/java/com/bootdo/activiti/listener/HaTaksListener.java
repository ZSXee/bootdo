...
public class HaTaksListener implements ExecutionListener  {
	...
	protected static final Logger LOGGER = LoggerFactory.getLogger(HaTaksListener.class);
	@Override
	public void notify(DelegateExecution arg0) throws Exception {
		...
		query.put("roleId", "4");//4角色为分行负责人
		query.put("deptId", deptId);
		if(userService != null){
			List<String> sysUserList = userService.listByRoleDept1(query);
