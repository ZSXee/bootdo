...
public class HSTaksListener implements ExecutionListener  {
...
//		rtxSend.SendRTXNotify(users.substring(5), "法律风险管理系统", "部门收到一个非格式合同任务，需要审批。", "0", "3");
