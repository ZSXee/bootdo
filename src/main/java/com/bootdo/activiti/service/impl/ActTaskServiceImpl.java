...
public class ActTaskServiceImpl implements ActTaskService {
     ...
     */		
    @Override
    public void complete(String taskId, Map<String, Object> vars, String comment, UserDO userDO) {
        // 2.1根据人物ID查询流程实例ID
        ...
        Authentication.setAuthenticatedUserId(userDO.getName());//批注人的名称  一定要写，不然查看的时候不知道人物信息
        taskService.addComment(task.getId(), processInstance, comment);
        // 2.3完成任务
        taskService.complete(taskId, vars);
    }
...
//                .generateDiagram(bpmnModel, "png", activeActivityIds);
     ...
     */
	@Override
	public void deleteProcessInstance(String procInsId, String comment) {
		// TODO Auto-generated method stub
		RuntimeService runtimeService = processEngine.getRuntimeService();
		runtimeService.deleteProcessInstance(procInsId, comment);
	}
