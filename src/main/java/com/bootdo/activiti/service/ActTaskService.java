...
public interface ActTaskService {
    ...
    InputStream tracePhoto(String processDefinitionId);

	void complete(String taskId, Map<String, Object> vars, String comment, UserDO userDO);
	
	void deleteProcessInstance(String procInsId, String comment);
}
