...
public class ShiroConfig {
    ...
    ShiroFilterFactoryBean shiroFilterFactoryBean(SecurityManager securityManager) {
        ...
        filterChainDefinitionMap.put("/file/tbContactFiles/download1","anon");
        filterChainDefinitionMap.put("/LS_SSO_Logon","anon");
        filterChainDefinitionMap.put("/activiti/task/deleteProcessInstance/**","anon");
