		...
		.bootstrapTable(
			{
				...
				url : prefix + "/toFinnishList", // 服务器数据的加载地址
				//showRefresh : true,
				// showToggle : true,
				// showColumns : true,
				iconSize : 'outline',
				...
				columns : [
                    ...
                    },
                    {
						...
						formatter : function(value, row, index) {
							var f = '<a class="btn btn-primary btn-sm " href="#" title="跟踪"  mce_href="#" onclick="track2(\''
								+ row.procInstId
                    ...
                    },
					{
						...
						align : 'center',
						formatter : function(value, row, index) {
							var f = '<a class="btn btn-primary btn-sm " href="#" title="查看"  mce_href="#" onclick="scan2(\''
...
function reLoad2() {
	$('#exampleTable2').bootstrapTable('getOptions').pageNumber = 1; // 设置到第一页
	$('#exampleTable2').bootstrapTable('getOptions').pageSize = 10; // 设置每页显示10
	$('#exampleTable2').bootstrapTable('refresh');
}
function scan2(processId,processDefinitionId) {
